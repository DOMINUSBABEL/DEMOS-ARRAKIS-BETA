...
export const TalleyrandLogoIcon: React.FC<{ className?: string }> = ({ className }) => (
  <svg className={className} xmlns="http://www.w3.org/2000/svg" viewBox="0 0 100 100" fill="none">
    {/* Compass Ring */}
    <circle cx="50" cy="50" r="40" stroke="#d4af37" strokeWidth="4" fill="none" />
    <circle cx="50" cy="50" r="30" stroke="#d4af37" strokeWidth="1" fill="none" opacity="0.5" />
    
    {/* Main Star (Blue) */}
    <path d="M50 10 L58 42 L90 50 L58 58 L50 90 L42 58 L10 50 L42 42 Z" fill="#002855" stroke="#d4af37" strokeWidth="1" />
    
    {/* Inner Star / Highlights (Gold) */}
    <path d="M50 10 L50 50 L90 50" fill="#d4af37" opacity="0.3" />
    <path d="M50 90 L50 50 L10 50" fill="#d4af37" opacity="0.3" />
...
export const SparklesIcon: React.FC<{ className?: string }> = ({ className }) => (
    <svg className={className} xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor">
        <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M5 3v4M3 5h4M6 17v4m-2-2h4m5-16l2.293 2.293a1 1 0 010 1.414L10 17l-4 4 4-4 2.293-2.293a1 1 0 011.414 0L17 14m-5-5l2.293 2.293a1 1 0 010 1.414L10 17" />
    </svg>
);
...
export const FilePdfIcon: React.FC<{ className?: string }> = ({ className }) => (
    <svg className={className} xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor">
        <path strokeLinecap="round" strokeLinejoin="round" d="M19.5 14.25v-2.625a3.375 3.375 0 0 0-3.375-3.375h-1.5A1.125 1.125 0 0 1 13.5 7.125v-1.5a3.375 3.375 0 0 0-3.375-3.375H8.25m.75 12 l3 3m0 0 3-3m-3 3v-6m-1.5-9H5.625a1.875 1.875 0 0 0-1.875 1.875v17.25a1.875 1.875 0 0 0 1.875 1.875h12.75a1.875 1.875 0 0 0 1.875-1.875V11.25a9 9 0 0 0-9-9Z" />
    </svg>
);

export const FileExcelIcon: React.FC<{ className?: string }> = ({ className }) => (
    <svg className={className} xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor">
        <path strokeLinecap="round" strokeLinejoin="round" d="M19.5 14.25v-2.625a3.375 3.375 0 0 0-3.375-3.375h-1.5A1.125 1.125 0 0 1 13.5 7.125v-1.5a3.375 3.375 0 0 0-3.375-3.375H8.25m2.25 0H5.625a1.875 1.875 0 0 0-1.875 1.875v17.25a1.875 1.875 0 0 0 1.875 1.875h12.75a1.875 1.875 0 0 0 1.875-1.875V11.25a9 9 0 0 0-9-9Z" />
        <path strokeLinecap="round" strokeLinejoin="round" d="m15.75 10.5-3 3m0 0-3-3m3 3V18" />
    </svg>
);
...
export const ScaleIcon: React.FC<{ className?: string }> = ({ className }) => (
  <svg className={className} xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor">
    <path strokeLinecap="round" strokeLinejoin="round" d="M12 3v17.25m0 0c-1.472 0-2.882.265-4.185.75M12 20.25c1.472 0 2.882.265 4.185.75M18.75 4.97A48.416 48.416 0 0 0 12 4.5c-2.291 0-4.545.16-6.75.47m13.5 0c1.01.143 2.01.317 3 .52m-3-.52v16.5m-1.5-16.5v16.5m0 0a48.291 48.291 0 0 0 3.75 .49m-3.75-.49a48.291 48.291 0 0 1-3.75 .49M3 4.97A48.416 48.416 0 0 1 12 4.5c2.291 0 4.545.16 6.75.47m-13.5 0c-1.01.143-2.01.317-3 .52m3-.52v16.5m1.5-16.5v16.5m0 0a48.291 48.291 0 0 1-3.75 .49m3.75-.49a48.291 48.291 0 0 0-3.75 .49" />
  </svg>
);
...
export const UserGroupIcon: React.FC<{ className?: string }> = ({ className }) => (
  <svg className={className} xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor">
    <path strokeLinecap="round" strokeLinejoin="round" d="M18 18.72a9.094 9.094 0 0 0 3.742-.587 9.094 9.094 0 0 0-3.742-.587m-12.036.587a9.094 9.094 0 0 1 3.742-.587m-3.742.587a9.094 9.094 0 0 0-3.742-.587m12.036.587c-1.296 0-2.583-.178-3.825-.53m-6.39 0c-1.242.352-2.529.53-3.825.53m12.036 0a9.094 9.094 0 0 0-3.742-.587M6.225 18.134a9.094 9.094 0 0 1-3.742-.587m12.036.587m-12.036.587a9.094 9.094 0 0 1 3.742-.587m5.94-15.586a9.094 9.094 0 0 1 3.742.587m-3.742-.587a9.094 9.094 0 0 0-3.742.587m5.94 0a9.094 9.094 0 0 0-3.742-.587M3 12a9 9 0 1 1 18 0 9 9 0 0 1-18 0Zm12-3a3 3 0 1 1-6 0 3 3 0 0 1 6 0ZM6 12a3 3 0 1 1 6 0 3 3 0 0 1-6 0Z" />
  </svg>
);
...
export const ShareIcon: React.FC<{ className?: string }> = ({ className }) => (
    <svg className={className} xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor">
      <path strokeLinecap="round" strokeLinejoin="round" d="M7.217 10.907a2.25 2.25 0 1 0 0-4.5 2.25 2.25 0 0 0 0 4.5Zm0 0v2.25m0-2.25h1.5m-1.5 0H5.717M10.5 7.5v2.25m0-2.25h1.5m-1.5 0h-1.5m6.75 4.5a2.25 2.25 0 1 0 0-4.5 2.25 2.25 0 0 0 0 4.5Zm0 0v2.25m0-2.25h1.5m-1.5 0h-1.5M15 15.75a2.25 2.25 0 1 0 0-4.5 2.25 2.25 0 0 0 0 4.5Zm0 0v2.25m0-2.25h1.5m-1.5 0h-1.5M9 14.25l-2.25-2.25M9 14.25v2.25m0-2.25h1.5m-1.5 0H7.5m6-6-2.25-2.25" />
    </svg>
);
